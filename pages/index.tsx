      ...
      <div id="menu-target" data-scroll-container ref={refScroll}>
        <Head>
          ...
          <meta
            ...
            content="#10101A"
          />
          <title>SAHIL VERMA 🚀 &mdash; Frontend Devloper</title>
          <meta
            name="description"
          ...
          <meta
            name="twitter:title"
            content="Sahil Verma 🚀 &mdash; Frontend Devloper"
          />
          <meta
        ...
        >
          <div className="preloader__wrapper">
            ...
            >
              <img src="svg/sahil.svg" alt="adeola logo" />
            </motion.div>
            <motion.div
              initial={{ x: 10, opacity: 0 }}
              animate={{ x: 0, opacity: 1, transition: { ...transition } }}
        ...
        <div className="header-wrapper">
          ...
          <div className="header__footer">
            ...
            <div className="header__footer--right">
              ...
              <a
                href="https://twitter.com/sahilverma1512"
                rel="noopener"
                target="_blank"
              >
                🐦 TW
        ...
        <main className="container">
          <p className="about-text">
            Hello stranger! 👋, my name is Sahil Verma and I am a frontend engineer,
          ...
          <section id="sectionProjects" className="section-projects">
            ...
            <div className="project-card">
              ...
              >
                <img src="webp/nagar-sarthi.png" alt="alexxandria model" />
                <img src="webp/nagar-sarthi.png" alt="alexxandria logo" />
              </div>
            ...
            <div className="project-card">
              <div className="project-card__left">
                <h4 className="heading-4">REACT JS</h4>
              </div>
              <div
                className="project-card__middle"
                data-displacement="webp/myDistorsionImage.webp"
              >
                <img src="webp/msc-abesit.png" alt="safarika" />
                <img src="webp/msc-abesit.png" alt="safarika logo" />
              </div>
              <div className="project-card__right">
                <h2
                  data-scroll
            ...
            <div className="project-card">
              ...
              <div
                ...
                data-displacement="webp/myDistorsionImage.webp"
              >
                <img src="webp/govsync.png" alt="heatrow" />
                <img src="webp/govsync.png" alt="heatrow logo" />
              </div>
              <div className="project-card__right">
                <h2
                  data-scroll
          ...
          <section className="section-contact">
            ...
            <h2 className="section-contact__h2">
              ...
              <a
                href="mailto:sahilverma1512@gmail.com"
                rel="noopener"
                target="_blank"
              >
                &nbsp; email 📧
        ...
        <footer className="footer">
          <img
            src="svg/sahil.svg"
            alt="design and devloped by sahil"
          />
